...
<body>
    ...
    <div class="nav" id="nav">
        <nav class="nav__content">
            ...
            <div class="nav__list">
                <a href="../Coordinador/profileUser.php" class="nav__link <?php echo ($currentPage == 'profileUser.php') ? 'active-link' : ''; ?>"><span class="nav__name">Perfil</span></a>
                <a href="../Coordinador/reports.php" class="nav__link <?php echo ($currentPage == 'reports.php') ? 'active-link' : ''; ?>"><span class="nav__name">Reportes</span></a>
