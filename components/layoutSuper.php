    ...
    <div class="nav" id="nav">
        <nav class="nav__content">
            ...
            <div class="nav__list">
                ...
                <a href="../User/ActivityUser.php" class="nav__link"><span class="nav__name">Solicitudes</span></a>
                ...
                <a href="../User/participantCertificate.php" class="nav__link"><span class="nav__name">Movimientos</span></a>
