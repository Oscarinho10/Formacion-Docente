...
// Debug para PHP 5.2.0 (con fopen en lugar de file_put_contents)
$fp = fopen("debug.log", "a");
fwrite($fp, date("Y-m-d H:i:s") . " - POST DATA:\n");
fwrite($fp, "id_usuario: " . $idUsuario . "\n");
fwrite($fp, "id_actividad: " . $idActividad . "\n");
fclose($fp);
