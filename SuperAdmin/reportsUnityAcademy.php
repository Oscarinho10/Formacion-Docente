...
<body class="bg-light">
      ...
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
          ...
          <div class="d-flex flex-wrap gap-2">
            <button onclick="window.location.href='<?php echo BASE_URL; ?>/SuperAdmin/reports.php'" class="btn btn-dark">
  ...
  <script src="<?php echo BASE_URL; ?>/SuperAdmin/js/reportsUnityAcademy.js"></script>
