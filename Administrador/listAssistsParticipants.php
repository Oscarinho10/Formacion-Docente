...
<body class="bg-light">
  <div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mt-3">
      ...
      <button onclick="window.location.href='<?php echo BASE_URL; ?>/Administrador/listAssists.php'" class="btn btn-dark">
  ...
  <script src="<?php echo BASE_URL; ?>/Administrador/js/listAssistsParticipantsScript.js"></script>

  <?php include('../Administrador/modalAdmin/detailsListActivity.php') ?>
  <?php include('../Administrador/modalAdmin/calendarModal.php') ?>
</body>
